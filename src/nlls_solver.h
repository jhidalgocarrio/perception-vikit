...
protected:
  ...
  bool                  have_prior_;
  ModelType prior_;
  Eigen::Matrix<double, D, D>  I_prior_; //!< Prior information Eigen::Matrix (inverse covariance)
  double                chi2_;
  double                rho_;
  Method                method_;
...
public:
  ...
  /// Damping parameter. If mu > 0, coefficient Eigen::Matrix is positive definite, this
